...
void printlogo() {
    for(int i=0; i<9; i++) {
       for(int j=0; j<55; j++) {
            if(logo[i][j] == '3')      printf("%c", 219);
            else if(logo[i][j] == '6') printf("%c", 176);
            else if(logo[i][j] == '5') printf("%c", 223);
            else if(logo[i][j] == '4') printf("%c", 220);
            else if(logo[i][j] == '2') printf("%c", 178);
            else if(logo[i][j] == '1') printf("%c", 177);
            else                       printf("%c", ' ');
       }
       printf("\n");
    }
